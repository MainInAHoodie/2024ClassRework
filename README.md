...
- **Witch Bolt**: Activating the ongoing damage now costs a Bonus Action instead of a full Action.  The damage, both initial and ongoing, has been reduced, but now both scale as follows:
    - 1st Level: 1d6
    - 2nd Level: 1d12
    - 3rd Level: 2d6
    - 4th Level: 3d6
